...
from app.api import chat, history, crawler, system_metrics, url_search, media_search, coverage, clients_api, media_api, sentiment_api, topics_api, coverage_api, opportunity_api, social_api, media_intelligence_api, reports_api
...
async def lifespan(app: FastAPI):
    ...
    yield
    try:
        from app.core.ingestion_scheduler import stop_scheduler
        stop_scheduler()
    except Exception:
        pass
